...
var alternate = true;
        ...
        $(function () {
            ...
            $("#player1").igVideoPlayer({
                ...
                width: 720,
                height: 272,
                posterUrl: 'http://jp.dev.igniteui.local/13-1/images/samples/video-player/ig-pres.png',
                fullscreen: false,
                ...
                banners: [{
                    imageUrl: 'http://jp.dev.igniteui.local/13-1/images/samples/video-player/banner.png',
